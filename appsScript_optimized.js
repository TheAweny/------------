...
class AromatherapyAnalyzer {
  ...
  processValidEntry(oil, zone, troika, entry, rowIndex) {
    ...
    Utils.setCellValue(this.sheets.input.getRange(rowIndex, CONFIG.COLUMNS.PE + 1), entry.pe);
    Utils.setCellValue(this.sheets.input.getRange(rowIndex, CONFIG.COLUMNS.S + 1), entry.s);
